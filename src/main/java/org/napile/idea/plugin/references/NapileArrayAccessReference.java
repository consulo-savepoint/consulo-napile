 ...
 * @author yole
 */
class NapileArrayAccessReference extends NapilePsiReference implements MultiRangeReference
{
	...
	public static PsiReference[] create(NapileArrayAccessExpressionImpl expression)
	{
		...
		return indicesNode == null ? PsiReference.EMPTY_ARRAY : new PsiReference[]{new NapileArrayAccessReference(expression)};
	}

	public NapileArrayAccessReference(@NotNull NapileArrayAccessExpressionImpl expression)
	{
		super(expression);
