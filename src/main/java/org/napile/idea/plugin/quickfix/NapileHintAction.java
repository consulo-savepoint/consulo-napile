 ...
 */
public abstract class NapileHintAction<T extends PsiElement> extends NapileIntentionAction<T> implements HintAction
{

	public NapileHintAction(@NotNull T element)
	{
		super(element);
	}
