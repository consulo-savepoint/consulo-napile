...
import org.napile.idea.plugin.quickfix.NapileIntentionActionFactory;
 ...
 */
@Deprecated
public class NapilePsiChecker implements Annotator
{
	...
	{
		NapilePsiChecker.namesHighlightingTest = namesHighlightingTest;
	}
	...
	private static Annotation registerQuickFix(@Nullable Annotation annotation, @NotNull Diagnostic diagnostic)
	{
		...
		Collection<NapileIntentionActionFactory> intentionActionFactories = QuickFixes.getActionFactories(diagnostic.getFactory());
		for(NapileIntentionActionFactory intentionActionFactory : intentionActionFactories)
		{
