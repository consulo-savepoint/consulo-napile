 ...
 * @author yole
 */
public class NapileReferenceContributor extends PsiReferenceContributor
{
	@Override
	public void registerReferenceProviders(PsiReferenceRegistrar registrar)
	{
		registrar.registerReferenceProvider(psiElement(NapileSimpleNameExpression.class), new PsiReferenceProvider()
		{
			...
			public PsiReference[] getReferencesByElement(@NotNull PsiElement element, @NotNull ProcessingContext processingContext)
			{
				return new PsiReference[]{
						new NapileSimpleNameReference((NapileSimpleNameExpression) element)
				};
			}
		});
		...
		registrar.registerReferenceProvider(psiElement(NapileArrayAccessExpressionImpl.class), new PsiReferenceProvider()
		{
			...
			public PsiReference[] getReferencesByElement(@NotNull PsiElement element, @NotNull ProcessingContext processingContext)
			{
				return NapileArrayAccessReference.create((NapileArrayAccessExpressionImpl) element);
			}
		});
	}
}
