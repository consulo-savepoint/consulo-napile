...
public class NapileCodeStyleSettings extends CustomCodeStyleSettings
{
	...
	public static NapileCodeStyleSettings getInstance(Project project)
	{
		return CodeStyleSettingsManager.getSettings(project).getCustomSettings(NapileCodeStyleSettings.class);
	}

	public NapileCodeStyleSettings(CodeStyleSettings container)
	{
