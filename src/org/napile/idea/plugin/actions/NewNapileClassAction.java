 ...
 */
public class NewNapileClassAction extends CreateFileFromTemplateAction
{
	public NewNapileClassAction()
	{
		super(NapileBundle.message("new.napile.file.action"), "Create New Class", NapileIcons.CLASS);
	}
	...
	{
		return NapileBundle.message("new.napile.file.action");
	}
	...
	{
		return obj instanceof NewNapileClassAction;
	}
}
